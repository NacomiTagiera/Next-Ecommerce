...
export type ProductListItemFragment = { slug: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> };

export type SingleProductColorVariantFragment = { __typename: 'ProductColorVariant', name: string };

export type SingleProductSizeVariantFragment = { __typename: 'ProductSizeVariant', name: string };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ quantity: number, product?: { slug: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> } | null }> } | null };
...
export type CategoryGetBySlugQuery = { category?: { description?: string | null, slug: string, name: string, products: Array<{ slug: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> } | null };
...
export type CollectionGetBySlugQuery = { collection?: { description?: string | null, slug: string, name: string, image: { url: string }, products: Array<{ slug: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> } | null };

export type CollectionsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionsGetListQuery = { collections: Array<{ slug: string, name: string }> };
...
export type ProductGetBySlugQuery = { product?: { slug: string, name: string, description: string, price: number, categories: Array<{ slug: string, name: string }>, images: Array<{ url: string }>, variants: Array<{ __typename: 'ProductColorVariant', name: string } | { __typename: 'ProductSizeVariant', name: string } | {}> } | null };
...
export type ProductsGetBySearchQuery = { products: Array<{ slug: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export type ProductsGetCountInCategoryQuery = { productsConnection: { aggregate: { count: number } } };
...
export type ProductGetListQuery = { products: Array<{ slug: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export const ProductsGetCountInCategoryDocument = new TypedDocumentString(`
  ...
  productsConnection(where: {categories_some: {slug: $slug}}) {
    ...
    `) as unknown as TypedDocumentString<ProductsGetCountInCategoryQuery, ProductsGetCountInCategoryQueryVariables>;
